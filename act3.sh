...
mv death_star/emperor_palpatine.txt empire mv death_star/* death_star/millenium_falcon mv empire/death_star/millenium_falcon/darth_vadar.txt  empire/death_star
...
mv star_wars/empire/death_star/darth_vadar.txt star_wars/rebellion
